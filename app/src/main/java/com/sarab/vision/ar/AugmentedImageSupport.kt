 ...
 *
 * The bundled marker (generated by tools/make_marker.py) is SQUARE, so print
 * it 30 cm x 30 cm. On A4, "fit to page" with margins lands very close to
 * 19 cm -- if you do that, set this to 0.19f instead.
 */
